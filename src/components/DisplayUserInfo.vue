<template>
	<div class="col-md-3">
		<div v-if="displayUser !== undefined">
			<img :src="url + displayUser.profilePicture" alt="profile picture" class="img-profile mr-3">
			...
			<div class="mt-3" v-if="displayUser.followerCount !== undefined && displayUser.followingCount !== undefined">
				...
				<div class="btn-group my-1">
					<form @submit.prevent="follow()" v-if="displayUser.possibleFollow" class="mt-2 float-right">
						<button class="btn btn-outline-primary mr-3" type="submit">Follow</button>
					</form>
					<form @submit.prevent="unFollow()" v-if="displayUser.possibleUnFollow" class="mt-2 float-right">
					...
					<form @submit.prevent="turnOnNotifications()" v-if="displayUser.possibleTurnOnNotifications" class="mt-2 float-right">
						<button class="btn btn-outline-info mr-3"><i class="far fa-bell"/></button>
					</form>
					<form @submit.prevent="turnOffNotifications()" v-if="displayUser.possibleTurnOffNotifications" class="mt-2 float-right">
